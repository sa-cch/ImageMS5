...
<div class="container">
	<div class="row">
		<div class="col">
			<h1>
			<img src="icons/iconfinder_Edit-01_1976055.png"> edit
			</h1>
			<form action="" method="post" enctype="multipart/form-data">
				<table>
					...
					<tr>
						<th>ソト / ナカ</th>
						<td>
							<input type="radio" name="areaTypesId" value="1"
								<c:if test="${areaTypesId == 1}">checked</c:if>>屋外
							<input type="radio" name="areaTypesId" value="2"
								<c:if test="${areaTypesId == 2}">checked</c:if>>屋内
						</td>
					</tr>
					<tr>
						<th>エリア</th>
